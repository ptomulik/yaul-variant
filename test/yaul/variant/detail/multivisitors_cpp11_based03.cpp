    ...
    // X1&&
    {
      // X2&
      {
        ...
        // X3&
        {
          ...
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(v,X1{1},x2,x3), 0x1131111);
        ...
        // X3 const&
        {
          ...
          V01::i1 = 0; V01::i2 = 0; V01::i3 = 0;
          static_assert(noexcept(apply_visitor(v,X1{1},x2,x3)), "");
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(v,X1{1},x2,x3), 0x1131112);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }
        // X3&&
        {
          ...
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(v,X1{1},x2,X3{3}), 0x1131113);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }
      ...
      // X2 const&
      {
        ...
        // X3&
        {
          ...
          V01::i1 = 0; V01::i2 = 0; V01::i3 = 0;
          static_assert(noexcept(apply_visitor(v,X1{1},x2,x3)), "");
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(v,X1{1},x2,x3), 0x1131211);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }
        // X3 const&
        {
          ...
          V01::i1 = 0; V01::i2 = 0; V01::i3 = 0;
          static_assert(noexcept(apply_visitor(v,X1{1},x2,x3)), "");
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(v,X1{1},x2,x3), 0x1131212);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }
        // X3&&
        {
          V01::i1 = 0; V01::i2 = 0; V01::i3 = 0;
          static_assert(noexcept(apply_visitor(v,X1{1},x2,X3{3})), "");
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(v,X1{1},x2,X3{3}), 0x1131213);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }
      ...
      // X2&&
      {
        // X3&
        {
          ...
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(v,X1{1},X2{2},x3), 0x1131311);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }
        // X3 const&
        {
          ...
          V01::i1 = 0; V01::i2 = 0; V01::i3 = 0;
          static_assert(noexcept(apply_visitor(v,X1{1},X2{2},x3)), "");
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(v,X1{1},X2{2},x3), 0x1131312);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }
        // X3&&
        {
          ...
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(v,X1{1},X2{2},X3{3}), 0x1131313);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }

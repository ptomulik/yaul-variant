...
//
// play with copy-/move- constructibility of compatible (but not identical) variants
//
...
{
  {
    ...
    yaul::variant<char,double,int,void*> v2{v1};
  ...
  }
  {
    // variant(variant&&)
    yaul::variant<int,char,double> v1{'a'};
    yaul::variant<char,double,int,void*> v2{std::move(v1)};
    YAUL_VARIANT_CHECK_EQUALS(v1.which(), 1);
    YAUL_VARIANT_CHECK_EQUALS(v2.which(), 0);
  }
}
...
void test__ctors__02()
{
  ...
  S s;
  {
    ...
    yaul::variant<S,double,int> v11{v1};
    yaul::variant<double,S,int> v12{v1};
    yaul::variant<double,int,S> v13{v1};
    YAUL_VARIANT_CHECK_EQUALS(v1.which(), 0);
    YAUL_VARIANT_CHECK_EQUALS(v11.which(), 0);
    YAUL_VARIANT_CHECK_EQUALS(v12.which(), 1);
    YAUL_VARIANT_CHECK_EQUALS(v13.which(), 2);
  }
  {
    // variant(variant&)
...
void test__ctors__04()
{
...

  {
    // variant(variant const&)
    yaul::variant<S,int,double> v1{S{}};
    yaul::variant<S,double,int> v11{std::move(v1)};
    yaul::variant<double,S,int> v12{std::move(v1)};
    yaul::variant<double,int,S> v13{std::move(v1)};
    YAUL_VARIANT_CHECK_EQUALS(v1.which(), 0);
    YAUL_VARIANT_CHECK_EQUALS(v11.which(), 0);
    YAUL_VARIANT_CHECK_EQUALS(v12.which(), 1);
    YAUL_VARIANT_CHECK_EQUALS(v13.which(), 2);
...
void test__ctors__05()
{
  ...
  // variant(variant&)
  {
    ...
    YAUL_VARIANT_CHECK_EQUALS(v1.which(), 0);
    yaul::variant<S, double, int> v2{v1};
  ...
  // variant(variant&&)
  {
    ...
    YAUL_VARIANT_CHECK_EQUALS(counter, 0x000);
    YAUL_VARIANT_CHECK_EQUALS(v1.which(), 0);
    yaul::variant<S, double, int> v2{std::move(v1)};

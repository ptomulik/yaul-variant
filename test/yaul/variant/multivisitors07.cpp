    ...
    // X1&
    {
      ...
      // X2&
      {
        ...
        // X3&
        {
          ...
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(V01{},x1,x2,x3), 0x3111111);
        ...
        // X3 const&
        {
          ...
          V01::i1 = 0; V01::i2 = 0; V01::i3 = 0;
          static_assert(noexcept(apply_visitor(V01{},x1,x2,x3)), "");
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(V01{},x1,x2,x3), 0x3111112);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }
        // X3&&
        {
          ...
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(V01{},x1,x2,X3{3}), 0x3111113);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }
      ...
      // X2 const&
      {
        ...
        // X3&
        {
          ...
          V01::i1 = 0; V01::i2 = 0; V01::i3 = 0;
          static_assert(noexcept(apply_visitor(V01{},x1,x2,x3)), "");
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(V01{},x1,x2,x3), 0x3111211);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }
        // X3 const&
        {
          ...
          V01::i1 = 0; V01::i2 = 0; V01::i3 = 0;
          static_assert(noexcept(apply_visitor(V01{},x1,x2,x3)), "");
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(V01{},x1,x2,x3), 0x3111212);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }
        // X3&&
        {
          V01::i1 = 0; V01::i2 = 0; V01::i3 = 0;
          static_assert(noexcept(apply_visitor(V01{},x1,x2,X3{3})), "");
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(V01{},x1,x2,X3{3}), 0x3111213);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }
      ...
      // X2&&
      {
        // X3&
        {
          ...
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(V01{},x1,X2{2},x3), 0x3111311);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }
        // X3 const&
        {
          ...
          V01::i1 = 0; V01::i2 = 0; V01::i3 = 0;
          static_assert(noexcept(apply_visitor(V01{},x1,X2{2},x3)), "");
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(V01{},x1,X2{2},x3), 0x3111312);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }
        // X3&&
        {
          ...
          YAUL_VARIANT_CHECK_EQUALS(apply_visitor(V01{},x1,X2{2},X3{3}), 0x3111313);
          YAUL_VARIANT_CHECK_EQUALS(V01::i1, 1);
          YAUL_VARIANT_CHECK_EQUALS(V01::i2, 2);
          YAUL_VARIANT_CHECK_EQUALS(V01::i3, 3);
        }
